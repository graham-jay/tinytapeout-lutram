...
module ccff_ram (clk, rst, D, Q, config_done, ccff_we, ccff_data);
    input clk;
    input rst;
    input D;
    output Q;
    ...
    mux mux0 (Q, ccff_data, ccff_we, w0);
    mux mux1 (D, w0, config_done, w1);
    dff dff0 (clk, rst, w1, Q);
endmodule

module configuration_chain (clk, rst, config_done, ccff_we, ccff_data, ccff_head, ccff_tail, ccff_out);
    input clk;
    input rst;
    input config_done;
    input [15:0] ccff_we;
    ...
    ccff_ram ccff_2  (clk, rst, w1,  w2,        config_done, ccff_we[0],  ccff_data);
    ccff_ram ccff_3  (clk, rst, w2,  w3,        config_done, ccff_we[1],  ccff_data);
    ccff_ram ccff_4  (clk, rst, w3,  w4,        config_done, ccff_we[2],  ccff_data);
    ccff_ram ccff_5  (clk, rst, w4,  w5,        config_done, ccff_we[3],  ccff_data);
    ccff_ram ccff_6  (clk, rst, w5,  w6,        config_done, ccff_we[4],  ccff_data);
    ccff_ram ccff_7  (clk, rst, w6,  w7,        config_done, ccff_we[5],  ccff_data);
    ccff_ram ccff_8  (clk, rst, w7,  w8,        config_done, ccff_we[6],  ccff_data);
    ccff_ram ccff_9  (clk, rst, w8,  w9,        config_done, ccff_we[7],  ccff_data);
    ccff_ram ccff_10 (clk, rst, w9,  w10,       config_done, ccff_we[8],  ccff_data);
    ccff_ram ccff_11 (clk, rst, w10, w11,       config_done, ccff_we[9],  ccff_data);
    ccff_ram ccff_12 (clk, rst, w11, w12,       config_done, ccff_we[10], ccff_data);
    ccff_ram ccff_13 (clk, rst, w12, w13,       config_done, ccff_we[11], ccff_data);
    ccff_ram ccff_14 (clk, rst, w13, w14,       config_done, ccff_we[12], ccff_data);
    ccff_ram ccff_15 (clk, rst, w14, w15,       config_done, ccff_we[13], ccff_data);
    ccff_ram ccff_16 (clk, rst, w15, w16,       config_done, ccff_we[14], ccff_data);
    ccff_ram ccff_17 (clk, rst, w16, ccff_tail, config_done, ccff_we[15], ccff_data);
...
module lutram4 (clk, rst, config_done, we, wdata, ccff_head, in, ccff_tail, out);
    input clk;
    input rst; 
    input config_done;
    input we;
